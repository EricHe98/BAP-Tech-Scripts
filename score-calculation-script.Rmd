...
event_info_key <- filter(sheets_table, name == "events_spring_2018") %>%
  pull(id)

#event_info_key <- filter(sheets_table, name == "event_info_cm_spring_2018") %>%
#  pull(id)

event_info_cm_key <- filter(sheets_table, name == "event_info_cm_spring_2018") %>%
  pull(id)

member_event_tech_key <- filter(sheets_table, name == "member_event_tech_spring_2018") %>%
  pull(id)

member_event_cm_key <- filter(sheets_table, name == "member_event_cm_spring_2018") %>%
  pull(id) 

exemptions_tech_key <- filter(sheets_table, name == "exemptions_tech_spring_2018") %>%
  pull(id) 

exemptions_cm_key <- filter(sheets_table, name == "exemptions_cm_spring_2018") %>%
  pull(id)

point_scores_cm_key <- filter(sheets_table, name == "point_scores_cm_spring_2018") %>%
  pull(id)

point_scores_tech_key <- filter(sheets_table, name == "point_scores_tech_spring_2018") %>%
  pull(id)
...
current_candidates_key <- filter(sheets_table, name == "spring_2018_candidates") %>%
  pull(id)
