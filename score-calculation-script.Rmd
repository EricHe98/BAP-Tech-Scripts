...
event_info <- gs_read_csv(ss = event_info_key)
...
new_event_names <- event_names[!(event_names %in% colnames(member_event_cm_mat))]
  ...
  #filter(event_info, (!Name %in% colnames(member_event_cm_mat)))
...
if (is_empty(exemptions_cm) == FALSE){
...
dummy_exemptions_tech <- cbind(exemptions_tech, exempt = TRUE)
  ...
  dummy_exemptions_cm <- data_frame(NetID = "", Name = "", exempt = "")
  dummy_exemptions_cm$exempt %<>% as.logical
  dummy_exemptions_tech <- data_frame(NetID = "", Name = "", exempt = "")
